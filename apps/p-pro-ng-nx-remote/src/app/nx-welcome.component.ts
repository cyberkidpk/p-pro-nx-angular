...
@Component({
  selector: 'p-pro-ng-nx-nx-welcome-remote',
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    <style>
      ...
      *,
      ...
      #hero-remote .text-container {
        color: rgba(255, 255, 255, 1);
        padding: 3rem 2rem;
      }
      #hero-remote .text-container h2 {
        font-size: 1.5rem;
        line-height: 2rem;
        position: relative;
      }
      #hero-remote .text-container h2 svg {
      ...
      #hero-remote .text-container h2 span {
        margin-left: 2.5rem;
      }
      #hero-remote .text-container a {
      ...
      #hero-remote .logo-container {
        display: none;
        justify-content: center;
        padding-left: 2rem;
        padding-right: 2rem;
      }
      #hero-remote .logo-container svg {
        color: rgba(255, 255, 255, 1);
        width: 66.666667%;
      }
    ...
    <div class="wrapper">
      <div class="container-remote">
        ...
        <!--  HERO  -->
        <div id="hero-remote" class="rounded">
        ...
        <h1>Graduates and Students Campus Program</h1>
        <p>
